...
namespace Rent_A_Car.Controllers
{
    public class RegisterViewModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Initials,FirstName,MiddleName,LastName,Address,PostalCode,City,Birthday,CreditCard,PhoneNumber,Email,Password,PasswordConfirm,RoleName")] RegisterViewModel registerViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Initials,FirstName,MiddleName,LastName,Address,PostalCode,City,Birthday,CreditCard,PhoneNumber,Email,Password,PasswordConfirm,RoleName")] RegisterViewModel registerViewModel)
        {
